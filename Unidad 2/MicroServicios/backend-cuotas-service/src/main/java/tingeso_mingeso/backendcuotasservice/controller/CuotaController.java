...
public class CuotaController {
    ...
    public String generarCuotasDePago(@PathVariable Long estudianteId, @RequestBody int numeroCuotas) {
    ...
    @PostMapping("/pagar")
    public ResponseEntity<String> pagarCuota(@RequestBody Long cuotaId) {
        try {
            cuotaService.pagarCuota(cuotaId);
            return new ResponseEntity<>("pagada", HttpStatus.OK);
    ...
    public String pagarCuotaVista(@RequestBody Long cuotaId) {
    ...
    public List<Cuota> cuotasPendientes(@RequestParam Estudiante estudiante) {
